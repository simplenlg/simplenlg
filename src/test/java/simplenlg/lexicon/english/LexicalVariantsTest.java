...
public class LexicalVariantsTest {
	...
	public void spellingVariantsTest() {
		...
		List<String> spellVars = asd.getFeatureAsStringList(LexicalFeature.SPELL_VARS);
	...
	public void spellingVariantsInVPTest() {
		...
		SPhraseSpec s = this.factory.createClause(this.factory.createNounPhrase("the", "doctor"),
		                                          eth,
		                                          this.factory.createNounPhrase("the patient"));
